    ...
    <main className="font-sans bg-gray-50 text-black min-h-screen">
      ...
      {showToast && (
        <div className="fixed top-4 right-4 z-50 animate-slide-in-right">
          <div className="bg-green-500 text-white px-6 py-4 rounded-lg shadow-2xl flex items-center space-x-3 min-w-[320px]">
            ...
            <div className="flex-1">
              <p className="font-semibold text-sm">Inquiry Sent Successfully!</p>
              <p className="text-xs mt-0.5 opacity-90">We'll get back to you soon.</p>
            </div>
            <button 
